...
describe InvitationsController do
 describe "routing" do
  ...
  it "routes to #new" do
    ...
    get("/invitations/event_create").should route_to("invitations#event_create")

  end
      it "routes to #send_invite" do
    get("/invitations/send_invite").should route_to("invitations#send_invite")

  end
      it "routes to #event_detail" do
    get("/invitations/event_detail").should route_to("invitations#event_detail")
